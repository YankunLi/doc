...
属于同一文件系统的所有目录和文件隶属于同一个vfsmount，该vfsmount结构对应于该文件系统顶层目录，即挂载目录。
ref[https://www.cnblogs.com/Wandererzj/archive/2012/04/12/2444888.html]
...
- 源文件系统用户将要挂载的文件系统
- 目的文件系统挂载源文件系统的文件系统
linux挂载文件系统主要分为三个阶段：1.创建源文件系统，2.查找目的文件系统的最终挂载目录并创建挂载节点，3.将源文件系统关联到挂载节点上。
